...
const Teams = () => {
  return (
    <div className="relative py-24" style={{ background: "#edf2f7" }}>
      <h2 className="text-center text-3xl font-bold">OUR TEAMS</h2>
      <div
        // style={{ height: "70vh" }}
      ...
      >
        ...
        >
          ...
          <div className="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            ...
            <div className="mt-8">
              <p className="text-xl font-semibold my-2">Web Development</p>
              <div className="flex space-x-2 text-gray-400 text-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
          ...
          <div className="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            ...
            <div className="mt-8">
              <p className="text-xl font-semibold my-2">Embedded System</p>
              <div className="flex space-x-2 text-gray-400 text-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
          ...
          <div className="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            ...
            <div className="mt-8">
              <p className="text-xl font-semibold my-2">Graphic Design</p>
              <div className="flex space-x-2 text-gray-400 text-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
