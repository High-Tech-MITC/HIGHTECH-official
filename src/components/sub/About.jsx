      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          <div class="flex flex-wrap w-full">
            <img
              class="invisible lg:visible lg:w-3/5 md:w-1/2 object-center md:mt-0 mt-12"
              width="100"
              src={team}
              alt="step"
            />
            <div class="text-center flex justify-center items-center lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              <div>
                <h1 className="text-3xl text-black underline font-bold">
                  ABOUT US
                </h1>
                <p className="text-left text-xl text-black p-8">
